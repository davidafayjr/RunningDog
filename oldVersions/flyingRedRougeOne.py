...
def runLeg(start_lat, start_lng, stop_lat, stop_lng, number_of_steps):
	...
	for index in indexes:
		...
		mydatabase.put("/GeoFire/Rouge One", 'l', {"0": lat, "1": lng})
		sleep(.01)

if __name__ == "__main__":

	
	intial_lat = mydatabase.get("/GeoFire/Rouge One/l", "0")
	intial_lng = mydatabase.get("/GeoFire/Rouge One/l", "1")

	lat_a, lng_a = (intial_lat, intial_lng)

	lat_b, lng_b = (lat_a+0.0007, lng_a - 0.0004)
	
	lat_c, lng_c = (lat_b-0.0009, lng_b + 0.0002)
	
	lat_d, lng_d = (lat_c- 0.0007, lng_c - 0.0005)
...
try:
	...
	mydatabase.put("/GeoFire/Rouge One", 'l', {"0": intial_lat, "1": intial_lng})
